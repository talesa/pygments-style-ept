...
"""
    ...
    Custom EPT color scheme.

    Based upon the pygments-style-github of Hugo Maia Vieira.

    pygments-style-github: https://github.com/hugomaiavieira/pygments-style-github

    :copyright: Copyright 2020 Adam Golinski
...
class EPTStyle(Style):
    ...
    styles[Generic.Emph] = 'bold #0054a9'
